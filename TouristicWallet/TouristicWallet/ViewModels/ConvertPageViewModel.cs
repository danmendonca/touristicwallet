...
{
    class ConvertPageViewModel : ViewModelBase
    {
        private SKCanvasView CView;

        public SKCanvasView Canvas
        {
            get { return CView; }
            set { CView = value; }
        }
        ...
        {
            System.Diagnostics.Debug.WriteLine("update graph");
            Currency dest = dataAccess.GetCurrency(convertTo);
        ...
        public void OnPaintDrawing(object sender, SKPaintSurfaceEventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("on Paint");
